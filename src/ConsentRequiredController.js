        ...
        return [
          FormType.View({
            View: new ConsentHeader({
              orgLogo: 'http://rain.okta1.com:1802/assets/img/logos/okta-logo.00b28e552573899e15fa6e77278759d5.png', // TODO where in the API??
          ...
          FormType.View({
            View: new ConsentBeacon({
              clientLogo: transaction.target.logo.href,
            })
          }),
          FormType.View({
          ...
          FormType.View({
            View: Okta.View.extend({
              ...
              template: '\
                ...
                {{#if termsOfService}}\
                  <a class="terms-of-service" href="{{termsOfService}}">\
                    Terms of Service\
                  </a>\
                {{/if}}\
                ...
                {{/if}}{{/if}}\
                {{#if privacyPolicy}}\
                  <a class="privacy-policy" href="{{privacyPolicy}}">\
                    Privacy Policy\
                  </a>\
                {{/if}}\
              ',
